...
export const everydayLessons = [
  l("daily-order", "Um café, por favor", 6, "Fazer um pedido simples e perguntar o preço.", [
    s("Peça com um substantivo + をください", "Este padrão serve para pedir um item. Comece chamando a atenção com すみません, se necessário. Em situações mais formais há outras maneiras de pedir, mas este é um bom ponto de partida.", [e("コーヒーをください。", "kōhī o kudasai", "Um café, por favor."), e("水をください。", "mizu o kudasai", "Água, por favor.")]),
  ...
  l("daily-find", "Encontre seu caminho", 6, "Perguntar onde fica um lugar e reconhecer respostas simples.", [
    s("Onde fica…?", "Use lugar + はどこですか para perguntar a localização. どこ significa onde. Acrescente すみません antes de abordar uma pessoa.", [e("駅はどこですか。", "eki wa doko desu ka", "Onde fica a estação?"), e("トイレはどこですか。", "toire wa doko desu ka", "Onde fica o banheiro?")]),
    s("Aqui, aí e ali", "ここ indica aqui; そこ, aí; あそこ, ali. Também vale aprender direita (右・みぎ) e esquerda (左・ひだり).", [e("ここです。", "koko desu", "É aqui."), e("あそこです。", "asoko desu", "É ali."), e("右です。", "migi desu", "É à direita.")])
  ], [
  ...
  l("daily-help", "Quando faltar uma palavra", 5, "Pedir repetição, falar sobre compreensão e manter a conversa.", [
    s("Tudo bem pedir ajuda", "Você não precisa fingir que entendeu. Aprenda blocos prontos para pedir repetição e ajustar o ritmo.", [e("もう一度お願いします。", "mō ichido onegai shimasu", "Mais uma vez, por favor."), e("ゆっくり話してください。", "yukkuri hanashite kudasai", "Fale devagar, por favor.")]),
    s("Mostre o que você entende", "わかりません expressa que você não entende ou não sabe naquele contexto. 少しだけ significa só um pouco. Essas expressões ajudam a pessoa a adaptar a conversa.", [e("すみません、わかりません。", "sumimasen, wakarimasen", "Desculpe, não entendi / não sei."), e("日本語は少しだけわかります。", "nihongo wa sukoshi dake wakarimasu", "Entendo só um pouco de japonês.")], "Aqui você aprende a expressão inteira. A forma て de 話して será aprofundada depois desta trilha introdutória.")
  ], [
...
export const casualLessons = [
  ...
  l("casual-slang", "Gírias com contexto", 6, "Entender マジ, やばい e めっちゃ sem tratar traduções como equivalências fixas.", [
    s("マジ: sério?", "マジ expressa seriedade, surpresa ou confirmação em conversa informal. Entre amigos, マジ？ pode significar “Sério?”. Em uma situação educada, 本当ですか é uma alternativa.", [e("マジ？", "maji?", "Sério? · informal"), e("本当ですか。", "hontō desu ka", "É mesmo? · educado")]),
    s("やばい muda com a situação", "やばい pode descrever perigo, um problema, algo impressionante ou uma reação intensa. Observe a expressão facial, a entonação e o contexto para entender se é positivo ou negativo.", [e("やばい、遅れる！", "yabai, okureru!", "Ih, vou me atrasar!"), e("このケーキ、やばい！", "kono kēki, yabai!", "Esse bolo é incrível! (num contexto de elogio)")]),
  ...
  l("casual-culture", "Expressões, internet e trabalho", 7, "Reconhecer expressões ligadas a situações e termos frequentes de comunidades.", [
    ...
    s("No trabalho e entre colegas", "お疲れさまです reconhece o esforço e funciona como saudação em contextos de trabalho e atividades compartilhadas. A tradução varia com a situação; nem sempre significa que a pessoa está cansada.", [e("お疲れさまです。", "otsukaresama desu", "Saudação / reconhecimento do trabalho.")]),
    s("Termos de comunidades", "推し (oshi) é a pessoa ou personagem que alguém apoia ou admira como fã. ネタバレ (netabare) é spoiler. Na internet, 草 (kusa, literalmente grama) pode marcar risada; seu uso depende da comunidade.", [e("ネタバレ注意", "netabare chūi", "Atenção: spoilers"), e("推し", "oshi", "favorito(a) que você apoia como fã")], "Jargões e gírias mudam. Este é um repertório inicial para entender situações, não uma lista universal de como todo japonês fala.")
  ], [
