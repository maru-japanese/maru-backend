...
export const foundationLessons = [
  l("welcome", "Japonês começa aqui", 5, "Reconhecer os três sistemas de escrita e saber por onde começar.", [
    ...
    s("Três escritas, um idioma", "Hiragana registra sons e aparece em palavras e terminações gramaticais. Katakana representa os mesmos sons e é comum em nomes estrangeiros e empréstimos. Kanji são caracteres ligados a significados, com leituras que dependem da palavra.", [e("ねこ", "neko", "gato · hiragana"), e("コーヒー", "kōhī", "café · katakana"), e("山", "yama", "montanha · kanji")], "Os três sistemas convivem na mesma frase. Romaji é uma ajuda de leitura, não um quarto sistema japonês."),
    s("Seu caminho daqui para a frente", "Conheça os sons, aprenda hiragana e katakana e descubra kanji dentro de palavras. Pratique escrita junto com leitura. Aos poucos, use partículas para formar frases e escolha expressões adequadas à situação.", [e("パンを食べます。", "pan o tabemasu", "Como pão.", "パン: katakana; を e べます: hiragana; 食: kanji.")])
  ], [
